...
const I18N = {
    ...
    messages: {
        ...
        'admin.removeAdmin': { 'zh-CN': '取消管理员', en: 'Remove Admin', ja: '管理者を解除', ko: '관리자 해제' },
        'admin.demote': { 'zh-CN': '取消管理员', en: 'Demote', ja: '降格', ko: '강등' },
        'admin.demoteConfirm': { 'zh-CN': '确定要取消该用户的管理员权限吗？', en: 'Remove admin privileges from this user?', ja: 'このユーザーの管理者権限を解除しますか？', ko: '이 사용자의 관리자 권한을 해제하시겠습니까?' },
